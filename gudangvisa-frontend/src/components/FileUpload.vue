...
<template>
  <div>
    ...
    <div
      ...
      :class="isDragging ? 'border-indigo-500 bg-indigo-500/10' : 'border-edge hover:border-indigo-500 hover:bg-indigo-500/5'"
    ...
    <div v-else class="flex items-center gap-3 p-4 border border-edge rounded-xl bg-panel-light">
      <div class="w-11 h-11 flex items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-400 flex-shrink-0">
