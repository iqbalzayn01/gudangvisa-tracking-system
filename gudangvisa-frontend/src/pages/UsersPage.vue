...
<template>
  <div class="max-w-4xl">
    ...
    >
      ...
      <select
        v-model="filterRole"
        class="px-3 py-2 bg-panel-light border border-edge rounded-lg text-heading text-[13px] outline-none cursor-pointer min-w-27.5 transition-colors focus:border-indigo-500"
      >
          ...
          >
            <td class="px-4 py-3 border-b border-edge">
              <div class="flex items-center gap-2.5">
                <div
                  class="w-8 h-8 rounded-lg bg-indigo-500/12 text-indigo-400 flex items-center justify-center font-bold text-[13px] shrink-0"
                >
                  {{ u.fullName.charAt(0) }}
                </div>
                <span
