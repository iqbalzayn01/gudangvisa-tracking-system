      ...
      <TransitionGroup name="toast">
        <div
          ...
          :class="{
            ...
            'border-l-3 border-l-red-500': notification.type === 'info',
          }"
        >
          <!-- Icons -->
          ...
          <svg v-else class="text-red-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
