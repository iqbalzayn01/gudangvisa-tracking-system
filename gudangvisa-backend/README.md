...
A REST API for tracking VISA, KITAS, and PASSPORT documents. Staff and admins manage immigration document tickets for clients, while clients can publicly track their application status using a tracking code.
...
│   ├── tickets/              # Tracking tickets (core)
│   ├── documents/            # File attachments per ticket
│   └── tracking/             # Public ticket tracking
├── scripts/
